...
const AboutUs = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-wrap justify-evenly w-screen max-w-[1280px] mx-auto ">
        {aboutArray.map((value, index) => (
          <div key={index} className="px-4 py-12 max-w-sm">
            <div className="relative flex rounded-[78px] min-w-sm h-[317px] bg-[#FA9A32] p-8 flex-col">
              <div className="absolute top-[-60px] left-1/2 transform -translate-x-1/2 w-[184px] h-[184px] mr-3 inline-flex items-center justify-center rounded-full flex-shrink-0">
                <img src={value.image} className={``} />
              </div>

              <div className="flex flex-col items-center flex-grow mt-28 max-w-[316px]">
