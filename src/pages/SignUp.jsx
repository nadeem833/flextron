...
const SignUp = () => {
  ...
  <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100 px-3">
    <div className="relative w-full max-w-[450px]">
      <img className="object-cover w-full h-28" src="https://img.freepik.com/free-psd/3d-character-young-man-with-business-concept_1150-64049.jpg?w=2000&t=st=1695475056~exp=1695475656~hmac=7d21c4d62e52c4683dac4ce1cc8a55d3f36d7af45f8493838474246ccca3f9fe" alt="image" />
      <div className="bg-gray-200 top-[75%] bg-transparent left-8 absolute">
        <img className='object-contain w-[72px] h-[72px] rounded-full' src="https://img.freepik.com/free-psd/engraved-black-logo-mockup_125540-223.jpg?size=626&ext=jpg&ga=GA1.1.1764889591.1695032775&semt=sph" alt="avatar" />
      </div>
    </div>

    <div className="bg-white p-4 md:p-8 shadow-md w-full max-w-[450px]">
      <form onSubmit={formik.handleSubmit}>
        <label htmlFor="email" className="block text-sm font-medium leading-6 text-gray-700 mb-2 mt-[40px] ">
          Email
        </label>

        <div className={` ${!(formik.touched.email && formik.errors.email) ? 'mb-4' : ''} border-gray-300 border rounded-md flex items-center h-9`}>
        ...
        {formik.touched.email && formik.errors.email && (
          <div className="text-red-600 text-xs mb-2 font-semibold py-2">{formik.errors.email}</div>
        )}

        <label htmlFor="password" className="block text-sm font-medium leading-6 text-gray-700 mb-2">
          Password
        </label>
        <div className={` ${!(formik.touched.password && formik.errors.password) ? 'mb-6' : ''} border-gray-300 border rounded-md flex items-center h-9`}>
          <input
        ...
        {formik.touched.password && formik.errors.password && (
          <div className="text-red-600 text-xs mb-6 font-semibold py-2">{formik.errors.password}</div>
        )}
